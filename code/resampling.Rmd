...
# ROOT tells it this notebook knits one level below the repo root
ROOT <- ".."
...
```{r}
write.csv(bootstrap_coef_YR, file.path(ROOT, paste("data-gen/boot_YR",gen,".csv",sep="")), row.names = F)
write.csv(bootstrap_coef_LB, file.path(ROOT, paste("data-gen/boot_LB",gen,".csv",sep="")), row.names = F)
```
